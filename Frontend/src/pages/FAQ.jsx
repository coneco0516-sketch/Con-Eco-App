...
function FAQ() {
  return (
    <div style={{ maxWidth: '800px', margin: '3rem auto', padding: '0 1rem' }}>
      <h2 style={{ fontSize: '2.5rem', color: 'white', marginBottom: '1rem', textAlign: 'center' }}>Frequently Asked Questions</h2>
      ...
      <div className="glass-panel" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
        <h3 style={{ color: 'white', marginBottom: '0.5rem' }}>What is ConEco?</h3>
      ...
      <div className="glass-panel" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
        <h3 style={{ color: 'white', marginBottom: '0.5rem' }}>How do I become a vendor?</h3>
      ...
      <div className="glass-panel" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
        <h3 style={{ color: 'white', marginBottom: '0.5rem' }}>Are the materials verified?</h3>
