    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '4rem 2rem 6rem' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.8rem', marginBottom: '2rem', padding: '0.5rem 1.2rem', background: 'rgba(46, 160, 67, 0.1)', border: '1px solid rgba(46, 160, 67, 0.2)', borderRadius: '30px' }}>
          ...
          <span style={{ fontSize: '0.9rem', fontWeight: '600', color: 'var(--primary-color)', letterSpacing: '0.5px', textTransform: 'uppercase' }}>Next-Gen B2B Construction Marketplace</span>
        </div>
        ...
        <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link to="/register" className="btn" style={{ fontSize: '1.2rem', padding: '1rem 2.5rem', borderRadius: '8px', boxShadow: '0 8px 20px var(--accent-glow)' }}>
            Get Started Free
          </Link>
          <Link to="/login" className="btn" style={{ fontSize: '1.2rem', padding: '1rem 2.5rem', borderRadius: '8px', background: 'transparent', border: '1px solid var(--surface-border)', color: 'var(--text-highlight)' }}>
            Log In
          </Link>
        </div>
      </div>
      ...
      <div style={{ marginBottom: '6rem' }}>
        <h2 style={{ textAlign: 'center', fontSize: '2.5rem', color: 'var(--text-highlight)', marginBottom: '3rem' }}>
          Engineered for B2B Procurements
        </h2>
        
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem' }}>
          
          <div className="glass-panel" style={{ padding: '2.5rem', borderRadius: '16px', border: '1px solid var(--surface-border)' }}>
      ...
      <div className="glass-panel" style={{ padding: '4rem 3rem', borderRadius: '24px', textAlign: 'center', border: '1px solid var(--surface-border)' }}>
        <h2 style={{ color: 'var(--text-highlight)', fontSize: '2.2rem', marginBottom: '3rem' }}>How it works</h2>
