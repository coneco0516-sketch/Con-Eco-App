...
function Privacy() {
  return (
    <div style={{ maxWidth: '800px', margin: '3rem auto', padding: '0 1rem' }}>
      <h2 style={{ fontSize: '2.5rem', color: 'white', marginBottom: '1rem', textAlign: 'center' }}>Privacy Policy</h2>
      <p style={{ color: 'var(--text-secondary)', marginBottom: '3rem', textAlign: 'center', fontSize: '1.2rem' }}>Last updated: March 2026</p>
      
      <div className="glass-panel" style={{ padding: '2rem' }}>
        <h3 style={{ color: 'white', marginBottom: '1rem' }}>1. Information We Collect</h3>
        ...
        <h3 style={{ color: 'white', marginBottom: '1rem' }}>2. Use of Information</h3>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', lineHeight: '1.6' }}>
        ...
        <h3 style={{ color: 'white', marginBottom: '1rem' }}>3. Data Security</h3>
